...
function Header({ aiMode, setAiMode, isDark, setIsDark }: HeaderProps) {
  return (
    <header className="w-full pt-12 sm:pt-16 pb-8 px-4 sm:px-6 md:px-16 border-b border-(--border) relative">
      <div className="max-w-7xl mx-auto relative flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-8 mt-12 md:mt-0">
        <div className="absolute -top-8 right-0 sm:-top-10 md:-top-8 flex items-center gap-4">
          {/* AI Mode Toggle */}
